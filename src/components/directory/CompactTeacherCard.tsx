      ...
      <CardContent className="p-4 flex flex-col h-full pl-5">
        ...
        <div className="mt-3 flex gap-2 border-t border-slate-100 pt-3">
          <Button 
            ...
            variant="outline" 
            size="sm"
            className="h-7 text-[10px] flex-1 bg-green-50 hover:bg-green-100 text-green-700 border-green-200 font-bold cursor-pointer"
          >
          ...
          <Dialog open={isEmailOpen} onOpenChange={(open) => {
            ...
            <DialogTrigger
              render={
                <Button 
                  ...
                  variant="outline" 
                  size="sm"
                  className="h-7 text-[10px] flex-1 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border-indigo-200 font-bold cursor-pointer"
                />
              }
            >
            ...
            <DialogContent onClick={(e) => e.stopPropagation()} className="sm:max-w-lg bg-white border border-slate-200 rounded-xl shadow-2xl p-6 overflow-hidden">
              {!isSentSuccess ? (
                <form onSubmit={handleSendEmail} className="space-y-4">
                  ...
                  {error && (
                    <div className="bg-rose-50 border border-rose-200 text-rose-850 text-xs font-semibold rounded-lg p-2.5 flex items-center gap-2">
