...
export const MOCK_TEACHERS: TeacherMockData[] = [
  ...
  },
  {
    ...
    alerts: [
      { id: 'a1', type: 'planeacion_atrasada', message: 'Planeación de Lenguaje 3-B retrasada' }
    ]
  },
  {
    id: 't-103',
    ...
    specialty: 'Ciencias Naturales Básicas',
    area: 'Ciencias',
    level: 'Primaria',
    campus: 'Sede Norte',
  ...
  },
  {
    ...
    specialty: 'Literatura e Idiomas',
    area: 'Lenguaje',
    level: 'Bachillerato',
    campus: 'Sede Principal',
